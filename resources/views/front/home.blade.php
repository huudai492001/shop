                            ...
                            <div class="item @if($i==0) active @endif">
                                ...
                                <ul class="thumbnails">
                                    ...
                                    <li class="span3">
                                        <div class="thumbnail">
                                            <i class="tag"></i>
                                            <a href="{{route('productView', $value->id)}}"><img src="{{asset('upload/'.$value->image)}}" alt=""></a>
                                            <div class="caption">
                                                <h5>{{$value->name}}</h5>
                                                <h4><a class="btn" href="{{route('productView', $value->id)}}">VIEW</a>
                                                    <span class="pull-right">${{$value->price}}</span></h4>
                                            </div>
                                        </div>
                                    </li>
                                    @endforeach
...
{{--                    End slide product--}}
        ...
        $i = 0;
        @endphp
        @foreach($products->chunk(10) as $product)
            <div class="item @if($i==0) active @endif">
            ...
            <ul class="thumbnails">
                ...
                <li class="span3">
                    <div class="thumbnail">
                        <a  href="product_details.html"><img src="{{asset('upload/'.$value->image)}}" alt=""/></a>
                        <div class="caption">
                            <h5>{{$value->name}}</h5>
                            <p>

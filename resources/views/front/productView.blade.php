        ...
        <div class="row">
            <div id="gallery" class="span3">
                <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
                    <img src="{{asset('upload/'.$product->image)}}" style="width:90%" alt="Fujifilm FinePix S2950 Digital Camera"/>
                </a>
            ...
            <div class="span6">
                ...
                <hr class="soft"/>
                <h4>{{$product->ProductDetail->total_items}} total items</h4>
                            ...
                            <div class="tab-pane active" id="blockView">
                                <ul class="thumbnails">
                                    @foreach($related_products as $related_product)
                                        <li class="span3">
                                            <div class="thumbnail">
                                                <a href="product_details.html"><img src="{{asset('upload/'.$related_product->image)}}" alt=""/></a>
                                                <div class="caption">
                                                    ...
                                                    <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a>
                                                        ...
                                                        <a class="btn btn-primary" href="#">${{$related_product->price}}</a></h4>
                                                </div>
                                            </div>
                                        </li>

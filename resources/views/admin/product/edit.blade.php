            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" action="{{route('product.update')}}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  name="category_id"  class="form-control col-md-7 col-xs-12">
                                            ...
                                            @foreach($categories as $categories)
                                                <option value="{{$categories->id}}" @if($product->category_id==$categories->id) selected @endif>
                                                    {{$categories->name}}
                                                </option>
                                            @endforeach
                                        </select>
